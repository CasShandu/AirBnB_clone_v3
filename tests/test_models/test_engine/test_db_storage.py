...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
	"""
	db storage test method by checking instances within it
	"""
	...
	"""
        storage = FileStorage()
        storage.reload()
        state_data = {"name": "Delaware"}
        state_instance = State(**state_data)
        storage.new(state_instance)


	city_data = {"name": "Rome", "state_id": state_instance.id}
